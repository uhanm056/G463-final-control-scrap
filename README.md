...
- Otevři `docs/index.html`. Záložky: Domů · Přehled · Finální kontrola Prefix (L1/L2 odděleně) ·
  Kontrola MC · Posouzení · Scrap · Data & metodika.
- **Domů** = dlaždice-rozcestník per zdroj (L1, L2, MC, posouzení PREFIX/SKLAD, sklad→rework, scrap):
  jedno číslo, semafor proti předchozímu dni, trend 10 dnů; klik = detail. Šipkami/datem lze zvolit jiný den.
